                    ...
                    <DialogContent className="sm:max-w-2xl">
                      ...
                      <ScrollArea className="h-96 pr-6">
                        <div className="space-y-4 text-sm text-muted-foreground">
                          <p>The story of Urban Attire began not in a bustling city boardroom, but in a quiet, unassuming workshop in 2010. It was there that our founder, a tailor with a singular vision, embarked on a journey to redefine modern apparel. Armed with little more than a sketchbook, a vintage sewing machine, and an unwavering belief in the power of craftsmanship, the first seeds of Urban Attire were sown.</p>
                          <p>In those early days, the brand was a one-person operation. Every design was sketched by hand, every pattern was meticulously cut, and every garment was stitched with a level of care that has become our hallmark. The philosophy was simple: create clothing that was not only stylish and contemporary but also timeless and durable. It was about moving beyond the fleeting trends of fast fashion to build a collection of essentials that people could live in, rely on, and love for years to come. The name 'Urban Attire' itself was inspired by the spirit of the modern individual—a symbol of strength, independence, and quiet confidence.</p>
                          <p>Our first collection consisted of just a handful of pieces: a perfectly tailored white shirt, a pair of rugged denim jeans, and a soft, versatile hoodie. These weren't just clothes; they were statements of intent. They represented a commitment to quality materials, ethical sourcing, and a design process that valued substance over spectacle. Word began to spread through the local community, not through splashy marketing campaigns, but through the quiet endorsement of those who wore our clothes. They spoke of the exceptional fit, the feel of the premium fabrics, and the subtle details that set Urban Attire apart.</p>
        ...
        <div className="mt-8 pt-8 border-t">
          <div className="flex flex-col md:flex-row items-center justify-between gap-6">
             <div className="flex gap-4">
              ...
              <a href="https://www.instagram.com" target="_blank" rel="noopener noreferrer" className="text-muted-foreground hover:text-primary">
                <Instagram className="h-5 w-5" />
              </a>
            </div>
            <p className="text-center text-sm leading-loose text-muted-foreground md:order-first">
              © {isMounted ? year : ''} Urban Attire. All Rights Reserved.
            </p>
          </div>
        </div>
      </div>
